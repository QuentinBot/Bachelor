...
def extract_text(directory):
    ...
    # #### BRACKET PATTERNS #### #
    pol_after_number_pattern = [{"TEXT": "lockdown", "OP": "?"}, {"TEXT": "emission", "OP": "?"}, {"LEMMA": {"IN": trend}}, {"TEXT": "("}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": "in"}, {"TEXT": {"IN": all_pollutants}}]
    ...
    # trend pollutant value
    pattern_t = [{"LEMMA": {"IN": trend}}, {"TEXT": "with", "OP": "?"}, {"TEXT": "the", "OP": "?"}, {"LOWER": "covid-19", "OP": "?"}, {"TEXT": "controls", "OP": "?"}, {"LEMMA": "be"}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": "("}, {"TEXT": "ACV", "OP": "?"}, {"TEXT": "=", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    two_pattern_reverse = [{"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": "and"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"LEMMA": {"IN": trend}}, {"LEMMA": "be", "OP": "?"}, {"TEXT": "found", "OP": "?"}, {"TEXT": "in"}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": "and"}, {"TEXT": {"IN": all_pollutants}}]
    ...
    pattern_x = [{"LEMMA": {"IN": trend}}, {"TEXT": "rate", "OP": "?"}, {"TEXT": "of"}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": "from", "OP": "?"}, {"TEXT": "P1", "OP": "?"}, {"TEXT": "to", "OP": "?"}, {"TEXT": "P4", "OP": "?"}, {"TEXT": "("}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ")"}, {"LEMMA": "be"}, {"TEXT": "comparable"}, {"TEXT": "to"}, {"TEXT": "the", "OP": "?"}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": "("}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    pattern_17 = [{"LEMMA": {"IN": trend}}, {"LEMMA": "ratio", "OP": "?"}, {"TEXT": "of"}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ","}, {"TEXT": {"IN": all_pollutants}}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and"}, {"TEXT": {"IN": all_pollutants}}, {"LEMMA": "be"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    # pollutant trend 4 values
    pattern_11 = [{"TEXT": {"IN": all_pollutants}}, {"LEMMA": "concentration", "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"TEXT": "almost", "OP": "?"}, {"LEMMA": {"IN": trend}}, {"TEXT": "in", "OP": "?"}, {"TEXT": "the", "OP": "?"}, {"TEXT": "TL", "OP": "?"}, {"TEXT": "phase", "OP": "?"}, {"TEXT": {"IN": ["(", "by"]}}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": ",", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": {"IN": ["-", "and"]}}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
