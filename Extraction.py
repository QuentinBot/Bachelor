...
pollutants_no_number = ["BLSO2", "AQIPM2.5", "AQINO2", "ozone", "PM2:5", "NO₂", "NOx", "NO", "PM", "BC", "CO", "O", "SO", "NH", "NMVOCS", "VOCs", "VOC", "VOCS", "AOD", "AQI", "BCFF", "BCWB", "OM", "BBOA", "HOA", "OOA", "PMPM", "NO2", "PM2.5", "PM10", "NOX", "O3", "SO2", "NH3", "NO3", "SO4"]
pollutants_numbers = ["2", "2.5", "10", "X", "3", "4"]

negative = ["decrease", "reduce", "drop", "decline", "plummet", "reduction", "lower", "-", "low", "negative", "improve", "enhancement"]
...
def extract_text(directory):
    ...
    pattern = [{"TEXT": {"IN": pollutants_no_number}}, {'TEXT': {"IN": pollutants_numbers}, 'OP': "?"}, {"LEMMA": {"IN": ["average", "mean", "also", "level", "have", "be", ",", "overall"]}, "OP": "?"}, {"TEXT": {"IN": ["of", "column", "a", "found", "which"]}, "OP": "?"}, {'LEMMA': {"IN": ["exhibit", "concentration", "emission", "over", "the", "significant", "to", "mainly"]}, 'OP': "?"}, {"TEXT": {"IN": ["entire", "in", "be", "emits"]}, "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": {"IN": ["interval", "signiﬁcantly", ",", "all", "a", "from"]}, "OP": "?"}, {"LEMMA": {"IN": ["have", "be", "show", "station", "include", "power"]}, "OP": "?"}, {"TEXT": {"IN": ["non", "the", "plants"]}, "OP": "?"}, {"TEXT": {"IN": ["-", "prelockdown", ","]}, "OP": "?"}, {"LEMMA": {"IN": ["significant", "and", "show"]}, "OP": "?"}, {"TEXT": "lockdown", "OP": "?"}, {"TEXT": "periods", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": "i.e.", "OP": "?"}, {"TEXT": "January", "OP": "?"}, {"TEXT": "–", "OP": "?"}, {"TEXT": "April", "OP": "?"}, {"TEXT": "2020", "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"LEMMA": {"IN": ["significant", "small"]}, "OP": "?"}, {"LEMMA": {"IN": trend}}, {"TEXT": {"IN": [",", "the", "at", "trend", "("]}, "OP": "?"}, {"TEXT": {"IN": ["�", "p", "both"]}, "OP": "?"}, {"TEXT": "<", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"TEXT": "only", "OP": "?"}, {"TEXT": "types", "OP": "?"}, {"TEXT": "of", "OP": "?"}, {"TEXT": "station", "OP": "?"},{"TEXT": "(", "OP": "?"}, {"TEXT": "Fig", "OP": "?"}, {"TEXT": ".", "OP": "?"}, {"TEXT": {"REGEX": "S[1-9]b"}, "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"LEMMA": "concentration", "OP": "?"}, {"TEXT": "in", "OP": "?"}, {"TEXT": "2020", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": "and", "OP": "?"}, {"TEXT": "its", "OP": "?"}, {"TEXT": "concentration", "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"LEMMA": {"IN": trend}, "OP": "?"}, {"TEXT": {"IN": ["by", "of", "the", "("]}, "OP": "?"}, {"TEXT": "an", "OP": "?"}, {"TEXT": {"IN": ["approximately", "about", "selected", "around", "(", "approx.", "average"]}, "OP": "?"}, {"TEXT": "cities", "OP": "?"}, {"LEMMA": "show", "OP": "?"}, {"TEXT": {"IN": ["up", "in", "ACV", "of"]}, "OP": "?"}, {"TEXT": {"IN": ["to", "Table", "="]}, "OP": "?"}, {"TEXT": "S1", "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"TEXT": "�", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    pattern_7 = [{"TEXT": "the"}, {"TEXT": "concentration"}, {"LEMMA": "be"}, {"TEXT": "slightly"}, {"LEMMA": {"IN": trend}}, {"TEXT": "by"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    # A significant reduction by 44.8% was observed in Mumbai
    pattern_8 = [{"TEXT": "A"}, {"TEXT": "significant"}, {"LEMMA": {"IN": trend}}, {"TEXT": "by"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"LEMMA": "be"}, {"LEMMA": "observe"}, {"TEXT": "in"}, {"POS": "PROPN"}]
    ...
    pattern_v = [{"TEXT": {"IN": pollutants_no_number}}, {"LEMMA": {"IN": ["be", "in", ","]}}, {"POS": "PROPN", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": {"IN": ["found", "and", "observed", "which"]}}, {"POS": "PROPN", "OP": "?"}, {"LEMMA": {"IN": ["from", "in", "to", "be", "have"]}}, {"LEMMA": "observe", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"POS": "NUM", "OP": "?"}, {"TEXT": {"IN": ["be", "to", "significant"]}, "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"POS": "NUM", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": {"IN": ["significantly", "2020", "be", "markedly", "emissions"]}}, {"TEXT": "(", "OP": "?"}, {"TEXT": "p", "OP": "?"}, {"TEXT": "<", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"TEXT": "from", "OP": "?"}, {"TEXT": "the", "OP": "?"}, {"TEXT": "transport", "OP": "?"}, {"TEXT": "sector", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"LEMMA": {"IN": trend}}, {"TEXT": "on", "OP": "?"}, {"TEXT": "an", "OP": "?"}, {"TEXT": {"IN": ["average", "significantly"]}, "OP": "?"}, {"TEXT": {"IN": ["(", "by"]}}, {"TEXT": "p", "OP": "?"}, {"TEXT": "<", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"TEXT": "during", "OP": "?"}, {"TEXT": "lockdown", "OP": "?"}, {"TEXT": "period", "OP": "?"}, {"TEXT": "in", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": "by", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ")", "OP": "?"}, {"TEXT": "over", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": "%", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ")", "OP": "?"}, {"TEXT": "and", "OP": "?"}, {"TEXT": "non", "OP": "?"}, {"TEXT": "-", "OP": "?"}, {"TEXT": "significant", "OP": "?"}, {"LEMMA": {"IN": trend}, "OP": "?"}, {"TEXT": "by", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": "%", "OP": "?"}]
    ...
    pattern_14 = [{"TEXT": {"IN": pollutants_no_number}}, {"LEMMA": {"IN": trend}}, {"TEXT": "("}, {"TEXT": "Fig"}, {"TEXT": "."}, {"TEXT": {"REGEX": "S[1-9]b"}}, {"TEXT": ")"}, {"TEXT": ","}, {"TEXT": "averaging"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": "at"}, {"TEXT": "SB"}, {"TEXT": "and"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    pattern_p = [{"TEXT": {"IN": pollutants_no_number}}, {"TEXT": ","}, {"TEXT": {"IN": pollutants_no_number}}, {"TEXT": ","}, {"TEXT": {"IN": pollutants_no_number}}, {"TEXT": ","}, {"TEXT": {"IN": pollutants_no_number}}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and"}, {"TEXT": {"IN": pollutants_no_number}}, {"TEXT": "in"}, {"TEXT": "2020"}, {"LEMMA": {"IN": trend}}, {"TEXT": "by"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    pattern_w = [{"TEXT": {"IN": pollutants_no_number}}, {"TEXT": ","}, {"TEXT": {"IN": pollutants_no_number}}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and", "OP": "?"}, {"TEXT": {"IN": pollutants_no_number}}, {"LEMMA": "concentration", "OP": "?"}, {"TEXT": "at", "OP": "?"}, {"TEXT": "the", "OP": "?"}, {"TEXT": "trafﬁc", "OP": "?"}, {"TEXT": "station", "OP": "?"}, {"TEXT": "with", "OP": "?"}, {"TEXT": "respective", "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"LEMMA": "sharp", "OP": "?"}, {"LEMMA": {"IN": trend}}, {"TEXT": "significantly", "OP": "?"}, {"POS": "PUNCT", "OP": "?"}, {"TEXT": {"IN": ["of", "by"]}}, {"TEXT": "approximately", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    # NO2 (−52.68%)
    pattern_z = [{"TEXT": {"IN": pollutants_no_number}}, {"TEXT": "("}, {"TEXT": {"REGEX": trend_number_regex}}, {"TEXT": "%"}, {"TEXT": ")"}]
    # NO2 (–68%)
    pattern_2 = [{"TEXT": {"IN": pollutants_no_number}}, {"TEXT": "("}, {"TEXT": "–"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ")"}]
    ...
    pattern_11 = [{"TEXT": {"IN": pollutants_no_number}}, {"LEMMA": "concentration"}, {"LEMMA": {"IN": trend}}, {"TEXT": "by"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": ","}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": ",", "OP": "?"}, {"TEXT": "and"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}]
    ...
    matcher.add("no_poll_matcher", [pattern_8, pattern_7, no_pollutant_pattern, pattern_c, pattern_l], on_match=no_pollutant_match)
    ...
    matcher.add("multi_matcher", [pattern_5, pattern_1, multi_pattern, second_multi_pattern, two_pattern_reverse, pattern_i, pattern_j, pattern_o, pattern_g, pattern_p, pattern_r, pattern_s, pattern_u, pattern_w, pattern_x, pattern_y], on_match=multi_matcher)
    ...
    for file in directories:
        ...
        for pg in range(len(pdf)):
            ...
            # for tok in doc:
            #     if tok.text == "2.8" and tok.nbor().text == "%":
            #         for t in tok.sent:
