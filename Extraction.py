...
pollutants_no_number = ["nitrate", "EC", "OC", "CO2", "benzene", "BLSO2", "AQIPM2.5", "AQINO2", "ozone", "PM2:5", "NO₂", "NOx", "NO", "PM", "BC", "CO", "O", "SO", "NH", "NMVOCS", "VOCs", "VOC", "VOCS", "AOD", "AQI", "BCFF", "BCWB", "OM", "BBOA", "HOA", "OOA", "PMPM", "NO2", "PM2.5", "PM10", "NOX", "O3", "SO2", "NH3", "NO3", "SO4"]
pollutants_numbers = ["2", "2.5", "10", "X", "3", "4"]

negative = ["decrease", "reduce", "drop", "decline", "plummet", "reduction", "lower", "-", "low", "negative", "improve", "enhancement", "halve", "diminish", "fall"]
positive = ["+", "increase", "positive", "rise", "up"]
...
def extract_text(directory):
    ...
    long_pattern_2 = [{"LEMMA": {"IN": trend}}, {"TEXT": "value", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": "p", "OP": "?"}, {"TEXT": "<", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"LEMMA": {"IN": ["of", "in", "be", "average"]}}, {"LEMMA": "observe", "OP": "?"}, {"TEXT": "the", "OP": "?"}, {"TEXT": "average", "OP": "?"}, {"LEMMA": {"IN": ["concentration", "emission"]}, "OP": "?"}, {"TEXT": {"IN": ["for", "of"]}, "OP": "?"}, {"TEXT": {"IN": pollutants_no_number}}, {"LEMMA": {"IN": ["concentration", "level"]}, "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"LEMMA": {"IN": ["record", "observe"]}, "OP": "?"}, {"TEXT": "in", "OP": "?"}, {"TEXT": "San", "OP": "?"}, {"TEXT": "Francisco", "OP": "?"}, {"TEXT": "and", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"LEMMA": {"IN": ["be", "of", "by", "("]}}, {"TEXT": "Fig", "OP": "?"}, {"TEXT": ".", "OP": "?"}, {"TEXT": "S3a", "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "slightly", "OP": "?"}, {"TEXT": {"IN": ["less", "higher"]}, "OP": "?"}, {"TEXT": "at", "OP": "?"}, {"TEXT": "UT", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": "about", "OP": "?"}, {"TEXT": "�", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": ")", "OP": "?"}, {"TEXT": {"IN": ["than", "and", "vs."]}, "OP": "?"}, {"TEXT": {"IN": ["at", "followed"]}, "OP": "?"}, {"TEXT": {"IN": ["UB", "by"]}, "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": "�", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": "%", "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "whereas", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"TEXT": "a", "OP": "?"}, {"TEXT": "non", "OP": "?"}, {"TEXT": "-", "OP": "?"}, {"TEXT": "significant", "OP": "?"}, {"LEMMA": {"IN": trend}, "OP": "?"}, {"LEMMA": "be", "OP": "?"}, {"LEMMA": "find", "OP": "?"}, {"TEXT": "in", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": {"REGEX": number_regex}, "OP": "?"}, {"TEXT": "%", "OP": "?"}]
    ...
    pattern_13 = [{"TEXT": {"IN": pollutants_no_number}}, {"LEMMA": "concentration", "OP": "?"}, {"LEMMA": "remain", "OP": "?"}, {"TEXT": "basically", "OP": "?"}, {"TEXT": "unchanged", "OP": "?"}, {"TEXT": "(", "OP": "?"}, {"TEXT": "Fig", "OP": "?"}, {"TEXT": ".", "OP": "?"}, {"TEXT": {"REGEX": "S[1-9]c"}, "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"TEXT": ",", "OP": "?"}, {"LEMMA": {"IN": ["be", "show"]}}, {"TEXT": "a", "OP": "?"}, {"TEXT": {"REGEX": number_regex}}, {"TEXT": "%"}, {"TEXT": "(", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": "/", "OP": "?"}, {"POS": "PROPN", "OP": "?"}, {"TEXT": ")", "OP": "?"}, {"LEMMA": {"IN": trend}}]
    ...
    matcher.add("multi_matcher", [pattern_19, pattern_17, pattern_16, pattern_5, pattern_1, multi_pattern, second_multi_pattern, two_pattern_reverse, pattern_i, pattern_j, pattern_o, pattern_g, pattern_p, pattern_r, pattern_s, pattern_u, pattern_w, pattern_x, pattern_y], on_match=multi_matcher)
    ...
    for file in directories:
        ...
        for pg in range(len(pdf)):
            ...
            # for tok in doc:
            #     if tok.text == "29" and tok.nbor().text == "%":
            #         for t in tok.sent:
